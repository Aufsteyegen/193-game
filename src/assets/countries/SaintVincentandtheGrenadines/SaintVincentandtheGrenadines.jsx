...
export function SaintVincentandtheGrenadines(props) {
  const { nodes, materials } = useGLTF('src/assets/countries/SaintVincentandtheGrenadines/SaintVincentandtheGrenadines.glb')
  return (
...
useGLTF.preload('src/assets/countries/SaintVincentandtheGrenadines/SaintVincentandtheGrenadines.glb')
