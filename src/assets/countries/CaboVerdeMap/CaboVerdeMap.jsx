...
export function CaboVerdeMap(props) {
  const { nodes, materials } = useGLTF('src/assets/countries/CaboVerdeMap/CaboVerdeMap.glb')
  return (
...
useGLTF.preload('src/assets/countries/CaboVerdeMap/CaboVerdeMap.glb')
